...
export function getLandingCopy(lang: LandingLang) {
  if (lang === 'fr') {
    return {
      ...
      tFaqSub: 'Introuvable ici? Essayez la barre de recherche ci-dessus, ou',
      ...
      steps: [
        { title: 'Nous l\'affichons correctement', body: 'Photographie professionnelle et marketing sur toutes les plateformes qui comptent — Facebook, Instagram, Kijiji et notre site.' },
        { title: 'Nous trouvons le bon locataire', body: 'Sélection complète de chaque candidat, préparation du bail, perception du dépôt et coordination de l\'emménagement.' },
        { title: 'Nous nous occupons du reste', body: 'Perception des loyers, relevés mensuels, inspections, entretien et soutien 24/7. Vous recevez un rapport; ils ont un excellent propriétaire.' },
      ],
      services: [
  ...
  return {
    ...
    tFaqSub: 'Can\'t find it here? Try the search bar above, or',
    ...
    steps: [
      { title: 'We list it properly', body: 'Professional photography and marketing across every platform that matters — Facebook, Instagram, Kijiji, and our own site.' },
      { title: 'We find the right tenant', body: 'Full screening on every applicant, plus lease or booking preparation, deposit collection, and move-in coordination.' },
      { title: 'We handle everything after', body: 'Rent collection, monthly statements, inspections, maintenance, and 24/7 support. You get a report; they get a great landlord.' },
    ],
    services: [
